...
const Product = ({
	...
	const handleMouseOver = () => {
		gsap.to(button.current, { scale: 1.1, duration: 0.2, ease: Linear.easeNone });
	};

	const handleMouseLeave = () => {
		gsap.to(button.current, { scale: 1, duration: 0.2, ease: Linear.easeNone });
	};
	...
	return (
		...
		>
			...
			>
				<span>{lang === 'ru' ? 'Добавить в корзинку' : "Savatga qo'shish"}</span>
