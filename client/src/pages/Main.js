...
const Main = () => {
	...
	return (
		<Section className="main-section">
				...
				{!smallScreen && (
					<>
						...
						<img
							...
							alt="snicker"
						/>
						<img src={data?.houses} id="houses-bg" className="houses" alt="houses" />
					</>
				)}
			...
			{isDayOffModal && (
				<DayOffModal
					className="main-day-off-modal"
					text={() => {
						return (
							<>
								Привет 👋 Спасибо, что заглянул в Di Cafe!
								<br />
								Сори, но суббота и воскресенье у нас выходные. Можешь пока погулять по
								сайту. Увидимся в понедельник 😉
							</>
						);
					}}
